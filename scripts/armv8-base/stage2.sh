...
cd /opt
/opt/scripts/build_eigen.sh armv8-base 3.4.0
...
cd /opt
/opt/scripts/build_opencv.sh armv8-base 4.11.0
...
cd /opt
/opt/scripts/install_dds.sh armv8-base 2.14.5 0.10.5
...
# Install Zenoh
cd /opt
/opt/scripts/install_zenoh.sh armv8-base 1.7.1
