...
cd /opt
/opt/scripts/install_rust.sh armv8-dev 1.85.0
...
cd /opt
/opt/scripts/install_nlohmann_json.sh armv8-dev 3.12.0
...
# Install ROS 2
cd /opt
/opt/scripts/install_ros2.sh armv8-dev jazzy 8294968ee233629c8fb223b2a29bb93ccce7480a
...
# Install Gazebo
cd /opt
/opt/scripts/install_gazebo.sh armv8-dev harmonic jazzy
